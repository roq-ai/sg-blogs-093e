...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['blog-owner', 'blog-author', 'blog-administrator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Reaction', path: '/reactions', entity: 'reaction', service: AccessServiceEnum.PROJECT, icon: FiThumbsUp },
