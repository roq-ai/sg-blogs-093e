...
function PostListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<PostInterface[]>(
    ...
    () =>
      getPosts({
        relations: ['user', 'comment.count', 'reaction.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('reaction', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>reaction</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
